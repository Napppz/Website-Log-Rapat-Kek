...
import { MeetingStatus, BiroCode } from '@/lib/types';
import { PlusCircle, Filter } from 'lucide-react';
import Link from 'next/link';

function SemuaRapatContent() {
...
export default function SemuaRapatPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-slate-500">Memuat data rapat...</div>}>
      <SemuaRapatContent />
    </Suspense>
  );
}
